...
SCOPE           the 23 blocks A09/R03 identified. Kc=Kw=4. Gate + demographics projected out (#77).
...
D=pd.DataFrame(rows)
OUT='E01_sexual_as_a_value_not_a_category/A10_is_the_item_effect_a_measurement/R08_the_metric_was_never_swept/results/'
