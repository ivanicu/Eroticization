...
SCOPE           the 23 blocks A09/R03 identified. Gate + demographics out of the scores (#77).
...
D=pd.DataFrame(rows)
OUT='E01_sexual_as_a_value_not_a_category/A10_is_the_item_effect_a_measurement/R13_every_component_against_its_own_null/results/'
