...
SCOPE           the 23 blocks A09/R114 identified. C fixed at Kc=4. Gate + demographics out (#77).
...
D=pd.DataFrame(rows)
OUT='E01_sexual_as_a_value_not_a_category/A10_is_the_item_effect_a_measurement/R124_rank_sweep_under_l1/results/'
