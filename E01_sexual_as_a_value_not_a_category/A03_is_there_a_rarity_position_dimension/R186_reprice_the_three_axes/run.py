...
IDENTIFICATION  与 A02/R034 **逐字相同**的公式与数据;只把"人"换成自助重抽。
SCOPE           A02/R034 的原口径。
WORLDS          KNIFE / ROBUST
...
REL_C=0.337                                   # A02/R034 实测的 coord4 分半(块分半,不随人自助)
...
g.asserted('⚠ A02 的 0.4 是**选定**阈值,从未对过任何地板',True,
           'A02/R034 源码 `mx<0.4 -> "still three axes"`;frontier §2 第九条')
