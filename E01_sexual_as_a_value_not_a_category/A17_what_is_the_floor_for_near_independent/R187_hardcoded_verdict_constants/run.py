...
#141c:A02/R034 的 `mx<0.4 -> "still three axes"` 是一个**选定**阈值,而它的自助区间
...
POSITIVE CTRL   #141 已知的刀尖(A02/R034 的 30.2%)必须被这套读法认出来。
...
WANT=['A03/R071','A10/R130','A10/R132','A10/R116','A11/R146','A11/R147','A11/R151','A11/R148',
      'A11/R150','A12/R166','A13/R171','A12/R158','A12/R162','A12/R168','A12/R169','A12/R170',
      'A11/R154','A02/R034','A02/R040','A02/R041','A03/R068']
paths=[]
for w in WANT:
    a,r=w.split('/')
...
for t,g in G[G.arm=='real'].groupby('thresh'):
    ...
    ratio=v.mean()/se
    rows.append(dict(round='#118 A12/R170',quantity=f'强度@{t}',value=ratio,const=3.0,
