...
exec(open(ROOT/'E01_sexual_as_a_value_not_a_category/A02_what_basis_should_the_ontology_be_written_in/R038_coordinate_count_specification_curve/run.py').read().split('rows=[]')[0].split('"""')[2])
