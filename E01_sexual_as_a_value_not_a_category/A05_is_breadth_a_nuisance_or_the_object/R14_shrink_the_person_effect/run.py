...
SCOPE           the 23 blocks A09/R03 identified.
...
IMPOSSIBLE      separating "breadth" from "acquiescence" -- they are the same row sum in this
                release, and #A05/R02 already measured that the distinction is not identifiable
...
D=pd.DataFrame(rows)
OUT=pathlib.Path(__file__).parent/'R14_shrink_the_person_effect'/'results'
