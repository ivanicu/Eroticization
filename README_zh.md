...
| **而且「偏爱冷门」不是不带立场的 —— 它带着羞耻** | 两道与块**零 item 重叠**的独立 Likert 题(n=15,503):位置分预测**羞耻 +0.1185**,并且穿过每一层控制 —— 勾选数(+0.1155)、性别(+0.1154)、**内容分本身**(**+0.1132,9.0× 自身自助 sd**)。内容只中介 **4.5%**,所以羞耻**不跟着**你喜欢哪些家族走。跨人打乱羞耻给 **+0.0008 ± 0.0118**(效应的 1%)。内部判别:同一条管道上「疗愈」从 +0.0937 **一控制勾选数就塌到 +0.0075** —— 所以这不是通用的方法学假象。⚠ 最严门槛(≥16 块,n=950)上羞耻衰减到 +0.0156;7 个门槛中 6 个同号。**横断面自报 —— 「因为冷门所以羞耻」与「因为羞耻所以只敢要冷门的」在此不可分** | `#179` |
