...
207 轮自我攻击,针对同一份公开数据集,问的是「在任何人再采一条数据之前,什么已经能被判定」。
**162 条编号账本条目** —— [RETRACTIONS.md](RETRACTIONS.md) 承载历史,这一页只承载**当前还站着的东西**。
...
| 文件 | 装的是什么 |
|---|---|
| [`RETRACTIONS.md`](RETRACTIONS.md) | **162 条。** 每一条被杀掉、被限定、被更正的声明,连同杀它的东西。绝大多数是我后来的一轮摧毁我前面的一轮 |
