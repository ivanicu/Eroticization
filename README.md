...
world-representations?** 197 self-attacking rounds against one public dataset, asking what can be
settled before anyone collects anything new. **152 numbered ledger entries** — [RETRACTIONS.md](RETRACTIONS.md)
...
| file | what it holds |
|---|---|
| [`RETRACTIONS.md`](RETRACTIONS.md) | **152 entries.** Every claim killed, scoped or corrected, with what killed it. Twelve are a later round of mine destroying an earlier round of mine |
