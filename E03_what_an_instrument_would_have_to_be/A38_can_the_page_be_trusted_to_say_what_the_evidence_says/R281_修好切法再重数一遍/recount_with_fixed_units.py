...
SRC = {
 798: E3/"A50_撤回要走到它引发的物件上/R237_页面上还有几处在用一个已死的结构/verify_the_retraction_landed.py",
 807: E3/"A57_两条更正要走到页面上/R246_不是没跑是跑不了而页面还没这么说/two_corrections_must_land.py",
 828: E3/"A72_两条更正落地/R267_未校正的标记与从没重数的欠账/land_two_corrections.py",
}
