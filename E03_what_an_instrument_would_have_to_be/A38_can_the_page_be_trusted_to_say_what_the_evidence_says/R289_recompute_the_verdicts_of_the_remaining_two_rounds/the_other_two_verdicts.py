...
JOBS = {
 807: dict(script=f"{E3}/A57_两条更正要走到页面上/R246_not_unrun_but_unrunnable_and_the_page_does_not_say_so/two_corrections_must_land.py",
           pairs=[("TOP", "MARK_TOP"), ("GEN", "MARK_GEN")]),
 828: dict(script=f"{E3}/A72_两条更正落地/R267_uncorrected_markers_and_a_debt_never_recounted/land_two_corrections.py",
           pairs=[("TARGET", "MARKED")]),
}
