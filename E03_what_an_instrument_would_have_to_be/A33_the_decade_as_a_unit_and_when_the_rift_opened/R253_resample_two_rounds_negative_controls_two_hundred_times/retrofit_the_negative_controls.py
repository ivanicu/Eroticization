...
J805 = json.load(open(ROOT/"E03_what_an_instrument_would_have_to_be/A55_页面上最大的那个数一个对照都没有/"
                      "R244_it_rode_the_threshold_twice_so_report_an_interval/results/interval_not_a_threshold.json"))
J806 = json.load(open(ROOT/"E03_what_an_instrument_would_have_to_be/A56_八条鸿沟每一条都欠同一个对照/"
                      "R245_can_a_common_shift_manufacture_a_zero_crossing/results/across_eight.json"))
